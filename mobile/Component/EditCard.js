...
class EditCard extends React.PureComponent {
    ...
    componentWillReceiveProps = (newProps) => { console.log('EditCard - componentWillReceiveProps'); };
    componentDidUpdate = (oldProps, oldState) => {  console.log('EditCard - componentDidUpdate ');};
    componentWillUnmount = () => {console.log(`EditCard  - componentWillUnmount`);};
