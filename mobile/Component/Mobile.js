...
export default class Mobile extends React.PureComponent {
    ...
    // componentWillUpdate = () => { };
    // componentDidUpdate = (oldProps, oldState) => { console.log('Mobile - componentDidUpdate '); };
        ...
        return (
            <div>
                ...
                <div className="new_client">
                    ...
                    {
                        newCard === 1 ?
                            <input type="button" value="Добавить клиента" onClick={this.changeNewClient}></input> :
                            newCard === 2 ?
                                <NewCard saveNewEmitter={this.saveNewEmitter}/> :
                                null
                    }
                </div>
            </div>
