...
class Filters extends React.PureComponent {
    ...
    // componentWillReceiveProps = (newProps) => { console.log('Filters - componentWillReceiveProps'); };
    // componentDidUpdate = (oldProps, oldState) => { console.log('Filters - componentDidUpdate '); };
